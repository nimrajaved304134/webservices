      ...
      <footer className="bg-gray-900 text-gray-300">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Company Info */}
            <div>
              <h3 className="text-xl font-bold text-white mb-4">WebServices Pro</h3>
              <p className="text-sm">
                Providing exceptional web development services since 2020.
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#" className="hover:text-white transition-colors">SEO Optimization</a>
                </li>
                <li>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800">
            <div className="flex justify-between items-center">
              <div className="text-sm">
                © 2024 WebServices Pro. All rights reserved.
              </div>
